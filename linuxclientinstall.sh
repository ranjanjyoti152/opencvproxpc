...
rendezvous_server = '122.161.193.234'
nat_type = 1
serial = 3

[options]
rendezvous-servers = 'rs-ny.rustdesk.com,rs-sg.rustdesk.com,rs-cn.rustdesk.com'
key = 'kvfwXO678HH27I5o9lGY9knCjFIbKEHpR6WPB0VvRCE='
custom-rendezvous-server = '122.161.193.234'
api-server = 'https://122.161.193.234'
relay-server = '122.161.193.234'
EOF
)"
